...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**17); // 0.1 LINK minimum auto send
...
contract TWOCHAINLINKS is
    BASEToken("2 Chains", "2CHAINLINKS", 100000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0xeE12ffc46F8e360edc1c91ddDa9969B62854CA0d;
